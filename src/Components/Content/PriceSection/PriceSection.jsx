...
const PriceSection = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try{
                const data = await fetch("https://min-api.cryptocompare.com/data/price?fsym=PLN&tsyms=BT,ETH,LTH,DOG&api_key=b5b71358c0a1de505b395c192ccb04645d8076288c16802d46e95a5f1dc98684");
                if (!data.ok){
